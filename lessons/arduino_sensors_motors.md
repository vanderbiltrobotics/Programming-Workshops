...
[This code](), when uploaded to the robot, will cause the motors to switch between low, medium, and high speed, remaining at each speed for 2 seconds.
...
[Here]() is code that reads values from the sensor
...
[A working arduino script is available here]() - try to get it working on your own before you look at this
